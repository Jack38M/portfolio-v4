...
(() => {
  ...
  function load() {
    ...
    // window.__imageSlotsFetchUrl lets a sub-folder page (e.g. projets/foo.html)
    // read the root sidecar even though writeFile always lands at root.
    loadP = fetch(window.__imageSlotsFetchUrl || STATE_FILE)
